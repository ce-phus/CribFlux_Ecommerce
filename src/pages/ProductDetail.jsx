...
const ProductDetail = () => {
    ...
    const { loading, error, product, relatedProducts } = useSelector(state => state.productDetailReducer)
                ...
                <nav className="flex mb-8" aria-label="Breadcrumb">
                    <ol className="flex items-center space-x-2 text-sm text-gray-400">
                        ...
                        <li className="flex items-center">
                            ...
                            <a href={`/category/${category_slug}`} className="hover:text-indigo-400 transition-colors capitalize">
